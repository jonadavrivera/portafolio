  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="text-[#ff9800]">laboral</span>
      </h2>
      <div
        id="experiencia-card"
          ...
          >
            ...
            <div className="mt-4 space-y-4">
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed text-base md:text-lg">
                Desarrollo de plataformas digitales de monitoreo y automatización
                en tiempo real con{' '}
                <span className="text-[#ff9800] font-semibold">Laravel 12</span>,{' '}
                <span className="text-[#ff9800] font-semibold">Livewire 3</span>,{' '}
                <span className="text-[#ff9800] font-semibold">React</span> y{' '}
                <span className="text-[#ff9800] font-semibold">Reverb</span>.
              </p>
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed text-base md:text-lg">
                Responsable de despliegues{' '}
                <span className="text-[#ff9800] font-semibold">Docker</span>,{' '}
                <span className="text-[#ff9800] font-semibold">SEO técnico</span>{' '}
                y arquitectura{' '}
                <span className="text-[#ff9800] font-semibold">multi-tenant</span>.
              </p>
            </div>
          </div>
        </div>
      ...
      >
        ...
        <p className="text-gray-700 dark:text-gray-300 leading-relaxed text-base md:text-lg">
          Experiencia independiente colaborando con empresas y clientes en el desarrollo de
          plataformas, paneles administrativos y herramientas internas. Trabajo en análisis,
          arquitectura, construcción y mejoras continuas, entregando soluciones claras, escalables
